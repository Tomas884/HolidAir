...
<html lang="en">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>HolidAir: Range Rover 2020 SUV</title>
		...
		<header></header>
		<div id="headerTxt">
		<p>Range Rover 2020 SUV</p>
		</div>
		<br/>
		<div id="carsArea"></div>
		<div id="carImage">
		<img border="1" id="carsImages" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021001.jpg" width="500" height="300">
		</div>
		...
		<div id="gallery1">
		<img border="1" id="carsImages2" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021002.jpg" width="200" height="100">
		</div>
		<div id="gallery2">
		<img border="1" id="carsImages3" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021003.jpg" width="200" height="100">
		</div>
		<div id="gallery3">
		<img border="1" id="carsImages4" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021011.jpg" width="200" height="100">
		</div>
		<div id="gallery4">
		<img border="1" id="carsImages5" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021012.jpg" width="200" height="100">
		</div>
		<div id="gallery5">
		<img border="1" id="carsImages6" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021028.jpg" width="200" height="100">
		</div>
		<div id="gallery6">
		<img border="1" id="carsImages7" alt="Range Rover 2020 SUV" src="css/range-rover-2020-suv/USD00LRS102A021025.jpg" width="200" height="100">
		</div>
		<div id="button1">
		<?php
		...
		<?php
		if (isset($_SESSION["userid"])) {
			echo ("<button onclick=\"location.href='rentCars/rentCars4.php'\">Rent Car</button>");
		} else {
