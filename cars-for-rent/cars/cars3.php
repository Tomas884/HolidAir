...
<html lang="en">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>HolidAir: Audi A6 2020</title>
		...
		<div id="carsArea"></div>
		<div id="carImage">
		<img border="1" id="carsImages" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021001.jpg" width="500" height="300"
		...
		<div id="gallery1">
		<img border="1" id="carsImages2" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021002.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="gallery2">
		<img border="1" id="carsImages3" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021003.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="gallery3">
		<img border="1" id="carsImages4" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021011.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="gallery4">
		<img border="1" id="carsImages5" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021012.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="gallery5">
		<img border="1" id="carsImages6" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021013.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="gallery6">
		<img border="1" id="carsImages7" alt="Audi A6 2020" src="css/audi-a6-2020/USC90AUC021A021025.jpg" width="200" height="100"
		style="width:100%;max-width:200px">
		</div>
		<div id="button1">
		<?php
		...
		<?php
		if (isset($_SESSION["userid"])) {
			echo ("<button onclick=\"location.href='rentCars/rentCars3.php'\">Rent Car</button>");
		} else {
