...
<html lang="en">
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<img border="1" id="locationsImgs" alt="Greece" src="css/greece/Ancient-Greece-in-High-Resolution.jpg" width="500" height="300">
		</div>
		...
		<div id="gallery1">
		<img border="1" id="locationsImgs2" alt="Greece" src="css/greece/a0bbfd078b5a73b6e3e3ea883f9b1e4b.jpg" width="200" height="100">
		</div>
		<div id="gallery2">
		<img border="1" id="locationsImgs3" alt="Greece" src="css/greece/thumb-1920-607341.jpg" width="200" height="100">
		</div>
		<div id="gallery3">
		<img border="1" id="locationsImgs4" alt="Greece" src="css/greece/219800.jpg" width="200" height="100">
		</div>
		<div id="gallery4">
		<img border="1" id="locationsImgs5" alt="Greece" src="css/greece/085f9c4832c169.jpg" width="200" height="100">
		</div>
		<div id="gallery5">
		<img border="1" id="locationsImgs6" alt="Greece" src="css/greece/hj2pj8gvlufa23s4rnst.jpg" width="200" height="100">
		</div>
		<div id="gallery6">
		<img border="1" id="locationsImgs7" alt="Greece" src="css/greece/athens.jpg" width="200" height="100">
		</div>
		<div id="button1">
		<?php
		...
		<?php
		if (isset($_SESSION["userid"])) {
			echo ("<button onclick=\"location.href='bookTravel/bookTravel8.php'\">Book Ticket</button>");
		} else {
